          ...
          <tbody>
            {byCategory.map(r => (
              <tr key={r.name} className="border-b border-gray-50 hover:bg-gray-50/50">
                ...
                <td className="py-3 px-4 text-right text-teal-600">{r.income.toLocaleString('en-US', { maximumFractionDigits: 2 })}</td>
                <td className="py-3 px-4 text-right text-red-500">{r.expense.toLocaleString('en-US', { maximumFractionDigits: 2 })}</td>
                <td className={`py-3 px-4 text-right font-medium ${r.profit >= 0 ? 'text-teal-600' : 'text-red-500'}`}>{r.profit.toLocaleString('en-US', { maximumFractionDigits: 2 })}</td>
              </tr>
            ))}
